...
async def get_credit_rating(ticker: str):
...
async def get_expert_advice():
    """Provides an investment suggestion based on available data."""
    try:
        required_keys = {"credit_rating", "news_sentiment", "stock_trend", "vision_mission_sentiment"}
        ...
        raise HTTPException(status_code=500, detail="Investment analysis failed.")
